...
def barnard_68(N):
    ...
    for m, zlow, zhigh in [(',', -1, 1)]:
        ...
        zss = randrange(N//1313*1000, 0, 0.3)
        for i in xss:
        ...
        z1s = randrange(N//2089*100, 0, 0.3)
        for i in x1s:
            if x1s[n]**2 + y1s[n]**2 <= 1:
                x1.append((x1s[n]-4.5)/6)
                y1.append((y1s[n]-4.1)/6)
                z1.append(z1s[n]/6)
                n += 1
            else:
                n += 1
        ...
        z2s = randrange(N//91825*1000, 0, 0.3)
        for i in x2s:
            if y2s[n]/(0.35-x2s[n]) <= 2.6/0.35:
                x2.append(((x2s[n]**2+y2s[n]**2)**0.5*np.cos(np.arctan(y2s[n]/x2s[n])+2.13)-2.9)/6)
                y2.append(((x2s[n]**2+y2s[n]**2)**0.5*np.sin(np.arctan(y2s[n]/x2s[n])+2.13)-1.8)/6)
                z2.append(z2s[n]/6)

                x3.append((((0.35-x2s[n])**2+y2s[n]**2)**0.5*np.cos(np.arctan(y2s[n]/(0.35-x2s[n]))+2.13)-1.7)/6)
                y3.append((((0.35-x2s[n])**2+y2s[n]**2)**0.5*np.sin(np.arctan(y2s[n]/(0.35-x2s[n]))+2.13)-4.1)/6)
                z3.append(z2s[n]/6)
                n += 1
            else:
                n += 1
        ...
        z4s = randrange(N//1671*100, 0, 0.3)
        for i in x4s:
            x4.append(((x4s[n]**2+y4s[n]**2)**0.5*np.cos(0.56+np.arctan(y4s[n]/x4s[n]))-4.05)/6)
            y4.append(((x4s[n]**2+y4s[n]**2)**0.5*np.sin(0.56+np.arctan(y4s[n]/x4s[n]))-4.9)/6)
            z4.append(z4s[n]/6)
            n += 1
        n = k
        xs5 = randrange(N//94955*10000, -4.4, 4.4)
        ys5 = randrange(N//94955*10000, -5, 5)
        zs5 = randrange(N//94955*10000, 0, 0.3)
        for i in xs5:
        ...
        for i in x6s:
            if y6s[n]/(3.2-x6s[n]) <= 0.7/3.2:
                x6.append((x6s[n]-3.5)/6)
                y6.append((y6s[n]-5.2)/6)
                z6.append(z6s[n]/6)
                n += 1
            else:
                n += 1
        ...
        for i in x7s:
            if y7s[n]/x7s[n] <= 0.7/1:
                x7.append((x7s[n]-4.7)/6)
                y7.append((y7s[n]-5.3)/6)
                z7.append(z7s[n]/6)
                n += 1
            else:
                n += 1
